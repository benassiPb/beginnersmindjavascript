let postsData = [
  {
    ...
    imageThree: "",
    sectionOneHeading: ["How to use resources"],
    sectionTwoHeading: ["Passing tests"],
    sectionThreeHeading: ["Pair Programming"],
    sectionFourHeading: ["Commiting often and staying narrow"],
    sectionFiveHeading: ["Communication"],
    sectionOneContent: [
